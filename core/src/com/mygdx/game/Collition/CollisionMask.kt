...
class OnlyTheseSpecificObjectsCollisionMask(private val objectsToCheck: List<GameObject>): CollisionMask{
    override val canCollideWith: (GameObject) -> Boolean = { other -> other in objectsToCheck }
}