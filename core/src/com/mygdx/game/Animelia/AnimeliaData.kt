...
class IcePenguinData(): AnimeliaData {
    override val gameTexture = DefaultTextureHandler.getTexture("Animelias/icepenguin-straight.png")
...
class FireHippoData(): AnimeliaData {
    override val gameTexture = DefaultTextureHandler.getTexture("Animelias/firehippo-straight.png")
    override val elemental_types: List<ELEMENTAL_TYPE> = listOf(ELEMENTAL_TYPE.FIRE)
